...
class EduController extends Controller
{
    ...
    {// validation fields
        ...
        return response()->json(
            [
                'message' => 'Education successfully registred',
    ...
    {// validation fields
        ...
        //return failed update:because this user havent this education
        if ($education == null) {
            return response()->json([
    ...
    public function destroy($id)
    {
        ...
        //return failed delete:because this user havent this education
        if ($education == null) {
            return response()->json([
                'message' => 'Your id does not exist or this item not your s',
            ], 400);
